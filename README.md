...
<ul style="direction: rtl; text-align: right;">
  <li style="direction: rtl;"><strong>Next.js (App Router):</strong><br>
  ...
  <li style="direction: rtl;"><strong>TanStack Query (React Query):</strong><br>
  ...
  <li style="direction: rtl;"><strong>IndexedDB (با پکیج idb):</strong><br>
  ...
  <li style="direction: rtl;"><strong>Tailwind CSS:</strong><br>
  ...
  <li style="direction: rtl;"><strong>ساختار پروژه و اصول کدنویسی:</strong><br>
